...
function TestPortHandler() {
    var socket = new WebSocket("ws://localhost:8000/ws/info/port");
...
function TestDirbHandler() {
    var socket = new WebSocket("ws://localhost:8000/ws/info/dirb")
    socket.onopen = function(e) {
        var msg = {
            gort_count: 20,
            dict: "php",
...
function TestCrawlHandler() {
    var socket = new WebSocket("ws://localhost:8000/ws/attack/crawl")
    socket.onmessage = function (e) {
        console.log(JSON.parse(e.data))
    }
    socket.onclose = function () {
...
function TestSQLiHandler() {
    var socket = new WebSocket("ws://localhost:8000/ws/attack/sqli")
    socket.onmessage = function (e) {
        console.log(JSON.parse(e.data))
    }
    socket.onclose = function () {
...
function TestXSSHandler() {
    var socket = new WebSocket("ws://localhost:8000/ws/attack/xss")
    socket.onmessage = function (e) {
        console.log(JSON.parse(e.data))
    }
    socket.onclose = function () {
...
function TestIntruderHandler() {
    var socket = new WebSocket("ws://localhost:8000/ws/attack/intrude")
    socket.onopen = function(e) {
        var msg = {
...
function TestRunDadPoCHandler() {
    var socket = new WebSocket("ws://localhost:8000/ws/poc/drupal-rce")
    socket.onopen = function(e) {
        var msg = {
            gort_count: 10,
        }
